...
class FedAvgCNN(nn.Module):
    def __init__(self, in_features=1, num_classes=10, dim=1024, dim1=512, dropout_rate=0.3):
        super().__init__()
        self.conv1 = nn.Sequential(
            ...
            nn.Dropout2d(dropout_rate)  # 卷积层后添加空间dropout
        )
        ...
        self.fc1 = nn.Sequential(
            nn.Linear(dim, dim1),
            nn.ReLU(inplace=True),
            nn.Dropout(dropout_rate)  # 全连接层后添加dropout
        )
